...
class GroupchatControl(BaseControl):
    ...
    def update_actions(self, *args):
        ...
        # Destroy Room
        self._get_action('destroy-').set_enabled(joined and
        ...
        self._get_action('request-voice-').set_enabled(joined and
                                                       contact.role.is_visitor)

        self._get_action('rename-groupchat-').set_enabled(joined)

        # Change Subject
        subject_change = self._is_subject_change_allowed()
        self._get_action('change-subject-').set_enabled(joined and
                                                        subject_change)
